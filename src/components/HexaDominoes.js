...
class HexaDominoes extends Component {
    constructor(props) {
        super(props);
        this.state = {
            deps: {},
    ...
    render() {
        ...
        if (this.props.resumeProjects && this.props.resumeBasicInfo) {
            var sectionName = this.props.resumeBasicInfo.section_name.hexaDominoes;
            var projects = this.props.resumeProjects.map(function (projects) {
                return (
                    ...
                    >
            <span>
              <div className="foto-simple" onClick={() => detailsModalShow(projects)}>
                <div >
                  <img
                      src={projects.thumbnail}
                      alt="projectImages"
                      style={{width: "100%", aspectRatio: 1, marginBottom: 0, paddingBottom: 0, position: 'relative', objectFit: "contain", backgroundColor: '#324C6F'}}
                  />
                </div>
              </div>
            </span>
        ...
        return (
            <section id="hexaDominoes" style={{height: window.innerHeight}}>
